...
class Shop extends Component {
  ...
  mainScreen = (user) => {
    ...
    return (
      <View style={{backgroundColor: '#f6f5f3', flex: 1, flexDirection: 'column'}}>
        <Animated.View style={{backgroundColor: '#f6f5f3', flex: 1, flexDirection: 'column', transform:[{translateY: firstLookSty}], opacity: this.state.opaciti}}>
