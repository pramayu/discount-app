      ...
      <View style={[common.container, { backgroundColor: '#fe9d07' }]}>
        ...
        <View style={{flex: .5, justifyContent: 'flex-end', alignItems: 'center'}}>
          <Animated.View style={{width: 150, height: 150, justifyContent: 'center', alignItems: 'center', opacity: 1, transform:[{translateY: logoToTopSty}]}}>
            <MaterialIcons name="landscape" color="#fdf4ec" size={72}/>
            <Text style={{transform: [{translateY: -20}],margin: 0,fontSize: 22, color: '#fdf4ec', letterSpacing: 3, fontFamily: 'Oswald'}}>POCENI</Text>
          </Animated.View>
        </View>
        <View style={{flex: .2, justifyContent: 'flex-end', alignItems: 'center'}}>
        </View>
        <Animated.View style={{flex: .4, justifyContent: 'center', alignItems: 'center', opacity: this.state.opaciti}}>
